...
class BasePage:
    ...
    def get_element(self, locator):
        ...
        return self._wait_until_element_should_be_visible(locator)

    def click_element(self, locator):
        try:
            self._wait_until_element_should_be_clickable(locator)
    ...
    def enter_text(self, locator, text):
        self._wait_until_element_should_be_visible(locator)
    ...
    def _wait_until_element_should_be_visible(self, locator):
        try:
            self.wait.until(expected_conditions.visibility_of_element_located(locator))
        except TimeoutException:
            raise TimeoutException(f"Element with locator {locator} is not visible within the specified timeout.")

    def _wait_until_element_should_be_clickable(self, locator):
        try:
    ...
    def _force_click_element(self, locator):
